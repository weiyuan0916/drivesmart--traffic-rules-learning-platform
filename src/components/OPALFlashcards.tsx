                    ...
                    {filteredCards.slice(0, 5).map((item, idx) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          <button
                            onClick={() => playPhraseAudio(item, idx)}
                            disabled={isPlayingPhrase !== null}
                            className={`
                      ...
                      <div className="mb-8">
                        ...
                        <div className="flex items-center justify-center gap-1 mb-6 h-12">
                          {[...Array(12)].map((_, i) => (
                            <motion.div
                              key={i}
                              animate={isPlayingPhrase !== null || isRecording ? {
                                height: [8, 24 + Math.random() * 24, 8],
                              } : { height: 8 }}
                              transition={isPlayingPhrase !== null || isRecording ? {
                                duration: 0.5,
                                repeat: Infinity,
                                delay: i * 0.05,
                              } : {}}
                        ...
                        {!isPlayingPhrase && !isRecording && (
                          <button
                            onClick={() => playPhraseAudio(currentItem, currentIndex)}
